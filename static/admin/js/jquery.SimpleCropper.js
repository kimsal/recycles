...
var help=null;
(function($) {
   $.fn.simpleCropper = function(id,name,temp_text) {
    // alert(id+":"+name+":"+temp_text);
    if(id==undefined)
      id="feature_image";
    if(name==undefined)
      name='feature_image';
    if(temp_text==undefined)
      temp_text='feature_image';
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='"+id+"' name='"+name+"'/><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok ok_"+id+"'></div></div></div>";
    ...
    $(document).ready(function() {
      ...
      //ok listener
      $('.ok_feature_image').click(function() {
        try{
            preview();
    ...
    function preview() {
      ...
      $('.'+temp_text+'[name="'+temp_text+'"]').attr('value', image_string);
      // Append it to the body element
      // alert($('#'+id+'[name="'+name+'"]').val());
      $('#'+id+'[name="'+name+'"]').attr('value',image_string);
      $('#preview').delay(100).hide();
      $('#modal').hide();
  ...
  $.fn.location2 = function(id,name,temp_text) {
    // alert(id+":"+name+":"+temp_text);
    if(id==undefined)
      id="feature_image";
    if(name==undefined)
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='"+id+"' name='"+name+"'/><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok ok_feature_image2'></div></div></div>";
    $('body').append(bottom_html);
